...
public interface PostRepository extends JpaRepository<Post, Integer> {
    ...
    Post findBySubjectAndContent(String subject, String content); // * 여러개의 속성을 동시에 조건으로 적용하고 싶을 땐, And 를 사용한다.
    ...
    List<Post> findBySubjectLike(String subject); // *Like 의 경우 특정 문자열이 포함되어 있는 데이터를 찾는 용도
